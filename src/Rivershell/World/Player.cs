...
namespace Rivershell.World
{
    ...
    public class Player : BasePlayer
    {
        ...
        {
            if (LastDeathTick != 0 && Server.GetTickCount() - LastDeathTick < (Config.RespawnTime*1000))
            {
        ...
        private void GoSpectatePlayer(BasePlayer player)
        {
            switch (State)
            {
        ...
        public override void OnDeath(DeathEventArgs e)
        {
            ...
            LastDeathTick = Server.GetTickCount();
            _lastKiller = killer;
